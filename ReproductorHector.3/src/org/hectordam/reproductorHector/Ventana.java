...
public class Ventana implements FullScreenStrategy{
	...
	private TablaReproduccion tabla;
	...
	private void inicializar(){
		...
		tabla = new TablaReproduccion(btnEliminar, btnReproducir);
	...
	private void cargarReproductor(){
		...
		btnHabilitar.setIcon(new ImageIcon("arrow-right-3.png"));
		panel.add(btnHabilitar, BorderLayout.EAST);
		...
		btnHabilitar.setBackground(Color.WHITE);
		btnHabilitar.setPreferredSize(new Dimension(12, 10));
	}
	...
	private void initialize() {
		...
		panel_1 = new JPanel();
		pnLista.add(panel_1, BorderLayout.CENTER);
