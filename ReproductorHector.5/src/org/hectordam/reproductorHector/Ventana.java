...
public class Ventana implements FullScreenStrategy{
	...
	public TablaRecientes tablaRecientes;
	...
	private void cargarReproductor(){
		...
		mediaPlayer.addMouseListener(new MouseAdapter() {
			@Override
	...
	private void initialize() {
		...
		btAdelantar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(mediaPlayer.getMediaPlayer().getTime() > mediaPlayer.getMediaPlayer().getLength() - 5000){
					mediaPlayer.getMediaPlayer().setTime(mediaPlayer.getMediaPlayer().getLength());
				}
				else{
					mediaPlayer.getMediaPlayer().setTime(mediaPlayer.getMediaPlayer().getTime() + 5000);
				}
			}
		});
		...
		btnReproducir.setIcon(new ImageIcon("media-playback-start-7.png"));
		...
		btnAnadir.setPreferredSize(new Dimension(25, 10));
		btnAnadir.setIcon(new ImageIcon("dialog-more.png"));
		...
		btnEliminar.setIcon(new ImageIcon("dialog-no-2.png"));
		...
		btnCancelar.setIcon(new ImageIcon("dialog-cancel-5.png"));
		...
		btnImagen.setIcon(new ImageIcon("archive-insert-3.png"));
		...
		btnBorrar.setIcon(new ImageIcon("archive-remove.png"));
					...
					.addGroup(gl_pnEste.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_pnEste.createSequentialGroup()
							...
							.addGroup(gl_pnEste.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_pnEste.createSequentialGroup()
									.addGap(27)
									.addGroup(gl_pnEste.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(btnEliminar, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
										.addComponent(btnAnadir, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 46, Short.MAX_VALUE))))
							.addPreferredGap(ComponentPlacement.RELATED, 39, Short.MAX_VALUE)
							.addGroup(gl_pnEste.createParallelGroup(Alignment.TRAILING)
								.addComponent(lblImagen)
								.addGroup(gl_pnEste.createParallelGroup(Alignment.TRAILING, false)
									.addComponent(btnBorrar, Alignment.LEADING, 0, 0, Short.MAX_VALUE)
									.addComponent(btnImagen, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)))
							.addPreferredGap(ComponentPlacement.RELATED, 52, Short.MAX_VALUE)
							.addGroup(gl_pnEste.createParallelGroup(Alignment.LEADING)
								.addGroup(Alignment.TRAILING, gl_pnEste.createSequentialGroup()
									.addGroup(gl_pnEste.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(btnReproducir, 0, 0, Short.MAX_VALUE)
										.addComponent(btnCancelar, GroupLayout.PREFERRED_SIZE, 42, Short.MAX_VALUE))
									.addGap(37))
								.addGroup(Alignment.TRAILING, gl_pnEste.createSequentialGroup()
			...
			gl_pnEste.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_pnEste.createSequentialGroup()
					...
					.addGroup(gl_pnEste.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(gl_pnEste.createSequentialGroup()
							.addComponent(btnReproducir, GroupLayout.PREFERRED_SIZE, 41, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
